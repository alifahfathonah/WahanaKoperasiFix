...
class DataPeminjaman extends React.Component {
    ...
    componentDidMount() {
        this.setState({ ActivityIndicator_Loading: true }, () => {
            ...
            const url = "http://api.wahanawar.com/rekening.php";
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        ...
                        <TouchableOpacity activeOpacity={0.7} style={styles.row}
                            onPress={() => this.props.navigation.navigate('DetailRekening', { id: item.noBuku })}>
                            ...
                            <View style={styles.info}>
                                <Text style={styles.songTitle}>Nomor Buku : {item.noBuku}</Text>
                                <Text style={styles.songDetails}>Nama Nasabah : {item.nama}</Text>
                                <Text style={styles.songDetails}>Pendaftaran : {item.tglPendaftaran}</Text>
                            </View>
