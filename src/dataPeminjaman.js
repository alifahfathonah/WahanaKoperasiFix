...
class DataPeminjaman extends React.Component {
    ...
    componentDidMount() {
        this.setState({ ActivityIndicator_Loading: true }, () => {
            ...
            const url = "http://api.wahanawar.com/peminjaman.php";
                ...
                <FlatList
                    ...
                    renderItem={({ item }) =>
                        ...
                        <TouchableOpacity activeOpacity={0.7} style={styles.row}
                            onPress={() => this.props.navigation.navigate('DetailPinjam', { id: item.idPeminjaman })}>
                            ...
                            <View style={styles.info}>
                                ...
                                <Text style={styles.songDetails}>Jumlah Pinjaman : {item.jumlah}</Text>
                                <Text style={styles.songDetails}>Lama Angsuran : {item.lamaAngsur}</Text>
                                <Text style={styles.songDetails}>Bunga Angsuran : {item.bunga}</Text>
                            </View>
